...
class LegacyLinkNotationConverterTest extends \CAG\CagTests\Core\Unit\UnitTestCase
{
    /**
    ...
    public function resolveFileReferencesToSplitParameters($input, $expected, $finalString)
    {
        ...
        /** @var LegacyLinkNotationConverter|\PHPUnit_Framework_MockObject_MockObject|\CAG\CagTests\Core\AccessibleObjectInterface $subject */
