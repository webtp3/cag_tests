 ...
 */
class SimpleLockStrategyTest extends \CAG\CagTests\Core\Unit\UnitTestCase
{
    /**
     * @test
     */
    ...
    public function acquireFixesPermissionsOnLockFile()
    {
        ...
        /** @var SimpleLockStrategy|\PHPUnit_Framework_MockObject_MockObject|\CAG\CagTests\Core\AccessibleObjectInterface $lock */
        $lock = $this->getAccessibleMock(SimpleLockStrategy::class, ['dummy'], ['999999999']);
