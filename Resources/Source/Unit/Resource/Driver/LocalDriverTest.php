...
class LocalDriverTest extends \TYPO3\CMS\Core\Tests\Unit\Resource\BaseTestCase
{
    ...
    {
        /** @var \TYPO3\CMS\Core\Resource\Driver\LocalDriver|\PHPUnit_Framework_MockObject_MockObject|\CAG\CagTests\Core\AccessibleObjectInterface $driver */
     ...
     * @param mixed $newFolderName
     * @param mixed $expectedFolderName
     */
     ...
     * @param mixed $oldFileIdentifier
     * @param mixed $newFileName
     * @param mixed $expectedNewIdentifier
     */
     ...
     * @param mixed $oldFolderIdentifier
     * @param mixed $newFolderName
     * @param mixed $expectedNewIdentifier
     */
